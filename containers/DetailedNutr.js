...
const DetailedNutr = props => {
  ...
  const brandName = foodObj.brand_name ? <Text>{foodObj.brand_name}</Text> : null;
...
export default connect(mapStateToProps, null)(DetailedNutr);
